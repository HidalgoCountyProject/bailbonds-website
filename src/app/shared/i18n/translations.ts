...
export const translations: Record<Language, TranslationSet> = {
  en: {
    ...
    'role.arrested.cta': 'Are you the arrested person? Click here',
    ...
    'role.indemnitor.cta': 'Are you the one paying the bail bond? Click here',
  ...
  es: {
    ...
    'role.arrested.cta': '¿Eres la persona arrestada? Haz clic aquí',
    ...
    'role.indemnitor.cta': '¿Eres quien va a pagar la fianza? Haz clic aquí',
